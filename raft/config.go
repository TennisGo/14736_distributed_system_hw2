...
type config struct {
	...
	rafts     []*Raft  // * an array of raft system node
	applyErr  []string      // from apply channel readers // * return information of application request of raft node 
...
// * make_config(t, servers: number of servers, false)
func make_config(t *testing.T, n int, unreliable bool) *config {
	...
	for i := 0; i < cfg.n; i++ {
		cfg.logs[i] = map[int]int{} // maps keys to values 
		cfg.start1(i) //
	}
